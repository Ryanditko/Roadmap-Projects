...
| # | Project | Description |
|---|---------|-------------|
| 1 | [Data Cleaning Pipeline](./beginner/01-data-cleaning-csv/) | Clean and preprocess raw CSV data |
| 2 | [Basic EDA Notebook](./beginner/02-basic-eda-notebook/) | Perform exploratory data analysis on a dataset |
| 3 | [Linear Regression Model](./beginner/03-linear-regression/) | Build a model predicting continuous values |
...
| 6 | [Simple Recommendation System](./beginner/06-recommendation-system/) | Create basic movie or product recommendations |
| 7 | [Text Sentiment Analysis](./beginner/07-sentiment-analysis/) | Analyze sentiment in reviews or social media |
...
| 5 | [A/B Testing Analysis](./intermediate/05-ab-testing-tool/) | Analyze experiment results statistically |
...
| 2 | [Real-Time Prediction System](./advanced/02-real-time-prediction/) | Deploy models serving predictions in real-time |
| 3 | [AutoML Pipeline](./advanced/03-automl-pipeline/) | Build automated machine learning system |
| 4 | [Deep Learning Model](./advanced/04-deep-learning-image/) | Train neural networks for image classification |
